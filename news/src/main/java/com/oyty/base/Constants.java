...
public class Constants {
    ...
    public static final String GRID_TOOLS_TITLE = "grid_tools_title";
    ...
    public interface Preferences {
        ...
        public static final String HOME_SLIDER_NEWS = "home_slider_news";
        public static final String HOME_GRID_NEWS = "home_grid_news";
        public static final String SMART_SERVICE_CATEGORIES = "smart_service_categories";
        public static final String NEWS_CENTER_PIC = "news_center_pic";
